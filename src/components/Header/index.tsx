...
const Header: React.FC = () => {
  const [isSidebarVisibile, setSidebarVisibility] =
  ...
  return (
    <div id="header-container">
      <div id="header-container-2">
        <img
          src={Icon}
          height={screenSize === "sm" ? 55 : 60}
          alt="Logo"
          className={`${screenSize === "sm" && "small-logo"}`}
        />
        {
          <div
            className={`flex gap-5 ${
              !isSidebarVisibile && screenSize !== "lg" && "hidden"
            } ${screenSize !== "lg" && "sidebar"}`}
          >
            <ul className="flex items-center text-white list-style-none gap-3">
              ...
              <li className="nav-item">
                <NavLink to={"/"} className="link" onClick={handleNavLinkClick}>
                  Home
                </NavLink>
              </li>
              <li className="nav-item">
